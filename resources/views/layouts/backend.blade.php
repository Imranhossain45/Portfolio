    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <!-- Main Start -->
        <li class="nav-item">
          ...
          <div id="collapseMain" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">

              <a class="collapse-item" href="{{ route('backend.main.create') }}">Add Main</a>
              <a class="collapse-item" href="{{ route('backend.main.index') }}">All Main</a>
            </div>
          </div>
        </li>
        <!-- Main end -->
        ...
        <li class="nav-item">
          ...
          <div id="collapseServices" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="{{ route('backend.service.create') }}">Add Services</a>
        ...
        <li class="nav-item">
          ...
          <div id="collapsePortfolio" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="#">All Portfolio</a>
            </div>
          </div>
        </li>
        <!-- Portfolio end -->
        ...
        <li class="nav-item">
          ...
          <div id="collapseAbout" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="#">Add About</a>
              <a class="collapse-item" href="#">All About</a>
            </div>
          </div>
        </li>
        <!-- About end -->
